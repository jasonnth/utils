...
public class DividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public DividerDecoration(Context context) {
        mDivider = ContextCompat.getDrawable(context, R.drawable.draw_divider);
    }

    public DividerDecoration(Context context, @ColorInt int color) {
        mDivider = ContextCompat.getDrawable(context, R.drawable.draw_divider);
        mDivider.setColorFilter(color, SRC_IN);
    }
